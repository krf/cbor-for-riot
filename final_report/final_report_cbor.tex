...
\subsection{API}
All of our \textit{serialize} functions receive a pointer to the CBOR struct where the serialized data is to be stored, and the value to be serialized. Every serialize function checks whether there is enough space left in the CBOR struct before writing any data (CBOR\_ENSURE\_SIZE).\\\\
...
Initially, we intended for our deserialize functions to return the deserialized values. Instead we decided to let them return the number of bytes read by them, so that the deserialize function that is called after them knows at which offset to continue.
...
\begin{itemize}
\item   2003-12-13T18:30:02Z          - supported
\item   2003-12-13T18:30:02.25Z       - not supported
\item   2003-12-13T18:30:02+01:00     - not supported
\item   2003-12-13T18:30:02.25+01:00  - not supported
\end{itemize}
...
Simple values:
\begin{itemize}
\item   0-19: (Unassigned)    - No support
\item  20,21: True, False     - Supported (see cbor\_serialize\_bool(), cbor\_deserialize\_bool())
\item  22,23: Null, Undefined - No support (what's the use-case?)
\item  24-31: (Reserved)      - Supported
\item  32-255: (Unassigned)   - No support
\end{itemize}
...
CBOR\_NO\_PRINT: All print functions removed, ENABLE\_DEBUG on\\
...
Link to pull request: \url{https://github.com/RIOT-OS/RIOT/pull/1415}\\
Link to CBOR branch: \url{https://github.com/krf/RIOT/tree/cbor/tests/unittests}

\section{References}
CBOR RFC: \url{https://tools.ietf.org/html/rfc7049}\\
CBOR implementations in other languages: \url{http://cbor.io/impls.html}\\
CBOR implementation in C++: \url{http://sourceforge.net/p/s11n/svn/HEAD/tree/c11n/include/s11n.net/c11n/c11n.h}\\
CBOR implementation in Python: \url{https://github.com/fritz0705/flynn}\\
CBOR implementation in Perl: \url{http://pod.tst.eu/http://cvs.schmorp.de/CBOR-XS/XS.pm}\\
CBOR implementation in JavaScript: \url{https://github.com/paroga/cbor-js}\\
RIOT OS source code: \url{https://github.com/RIOT-OS/RIOT/}\\
RIOT OS wiki: \url{https://github.com/RIOT-OS/RIOT/wiki}\\
