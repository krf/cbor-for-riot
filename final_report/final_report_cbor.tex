...
\hypersetup{
    ...
    pdftitle={Final Report: Implementation of CBOR for RIOT},    % title
    pdfauthor={Kevin Funk and Jana Cavojska},     % author
    pdfsubject={Final Report: Implementation of CBOR for RIOT},   % subject of the document
    pdfkeywords={CBOR} {Riot} {C}, % list of keywords
